...
export default function Navbar() {
    ...
    return (
        <Fragment>
            <div className="d-flex justify-content-center justify-content-md-end align-items-center p-2 my-2">
                {
                    user ?
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item mx-4">
                                <Link to='/products' className="nav-link text-decoration-none text-reset text-center">
                                    All Products
                                </Link>
                            </li>
                            <li className="nav-item mx-4">
                                <Link to='/orders' className="nav-link text-decoration-none text-reset text-center">
                                    Orders
                                </Link>
                            </li>
                        </ul>
